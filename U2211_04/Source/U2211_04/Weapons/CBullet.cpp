...
{
#if DEBUG_LOG_HIT_DESC
	CLog::Log(L"HitComponent : " + HitComponent->GetName());
	CLog::Log(L"OtherActor : " + OtherActor->GetName());
	CLog::Log(L"OtherComp : " + OtherComp->GetName());
#endif
